...
def run_sprint2_pipeline(db_path: str = "nifty100.db") -> Dict[str, Any]:
    ...
    print(
        "           EXECUTING SPRINT 2 — FINANCIAL RATIO ENGINE FULL PIPELINE               "
    )
    print(
        "==================================================================================="
    )
    ...
    print(
        "                    SPRINT 2 PIPELINE EXECUTION SUMMARY                            "
    )
    print(
        "==================================================================================="
    )
    print(
        f"1. financial_ratios rows populated : {pipeline_summary['total_ratio_rows']}"
    )
    print(
        f"2. Capital allocation CSV generated  : {pipeline_summary['capital_allocation_csv']}"
    )
    ...
    print(
        f"5. Equity screener matching count   : {pipeline_summary['screener_matching_companies']} companies"
    )
    print(
        "==================================================================================="
    )
