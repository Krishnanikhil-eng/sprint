...
def generate_ratio_edge_case_log(
    ...
    log_entries.append("===================================================================================")
    log_entries.append("               SPRINT 2 — FINANCIAL RATIO ENGINE EDGE CASE & ANOMALY LOG           ")
    log_entries.append("===================================================================================\n")
        ...
        if calc_roe is not None and src_roe is not None and not pd.isna(src_roe):
            ...
            if diff_roe > 5.0:
                ...
                if is_fin:
                    ...
                    cat = "data source issue"
                    expl = f"Data source anomaly: source Excel reflects consolidated group ROE vs standalone equity base."
                else:
                    cat = "formula discrepancy"
                    expl = f"Formula definition difference: source Excel uses average equity over 2 years vs ending year equity."
    ...
    print(f"Edge case log generated at {output_log_path} with {anomaly_count} logged anomalies.")
