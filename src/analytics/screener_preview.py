...
def run_screener_preview(db_path: str = 'nifty100.db') -> pd.DataFrame:
    ...
    print("===================================================================================")
    print("               SPRINT 2 — SCREENER PREVIEW (ROE > 15%, D/E < 1.0)                 ")
    print("===================================================================================")
    ...
    print("\n===================================================================================")
    print(f"SCREENER VALIDATION RESULT: {'PASS (Count within expected range 15-50)' if valid_range else 'FAIL (Out of range)'}")
    print("===================================================================================")
    return df_screener
