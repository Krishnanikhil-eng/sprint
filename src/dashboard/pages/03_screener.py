...
filter_keys = [
    'min_roe', 'max_de', 'min_fcf', 'min_revenue_cagr', 'min_pat_cagr',
    'min_opm', 'max_pe', 'max_pb', 'min_dividend_yield', 'min_icr'
]
    ...
    if selected_preset in PRESET_STRATEGIES:
        ...
        for key in filter_keys:
            if key in preset_dict:
                ...
                st.session_state[f"filter_{key}"] = float(SCREENER_DEFAULTS.get(key, 0.0))
...
if not filtered_df.empty:
    ...
    numeric_cols = [
        ...
        'pe_ratio', 'pb_ratio', 'dividend_yield_pct', 'free_cash_flow_cr',
        'revenue_cagr_5yr', 'pat_cagr_5yr', 'operating_profit_margin_pct', 'interest_coverage'
    ]
    ...
    st.warning("No companies match your current filters. Try relaxing criteria or choosing a preset.")
