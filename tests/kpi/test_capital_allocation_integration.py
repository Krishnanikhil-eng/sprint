...
def test_capital_allocation_completeness_and_distribution(tmp_path):
    ...
    df_cap_dummy = pd.DataFrame([
        {"company_id": "COMP_A", "year": 2023, "cfo_sign": "+", "cfi_sign": "-", "cff_sign": "-", "pattern_label": "Reinvestor"},
        {"company_id": "COMP_A", "year": 2024, "cfo_sign": "-", "cfi_sign": "+", "cff_sign": "+", "pattern_label": "Distress Signal"},
        {"company_id": "COMP_B", "year": 2023, "cfo_sign": "+", "cfi_sign": "-", "cff_sign": "-", "pattern_label": "Shareholder Returns"},
        {"company_id": "COMP_B", "year": 2024, "cfo_sign": "+", "cfi_sign": "-", "cff_sign": "-", "pattern_label": "Shareholder Returns"},
    ])
