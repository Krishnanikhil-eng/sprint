...
def test_batch_tearsheet_generation_and_skipped(tmp_path):
    ...
    for y in [2020, 2021, 2022, 2023, 2024]:
        cur.execute("INSERT INTO profitandloss VALUES ('FULL_CO', ?, 1000.0, 200.0, 20.0, 10.0, 25.0, 250.0, 10.0);", (y,))
        cur.execute("INSERT INTO balancesheet VALUES ('FULL_CO', ?, 100.0, 900.0, 50.0, 1100.0);", (y,))
        cur.execute("INSERT INTO cashflow VALUES ('FULL_CO', ?, 220.0, -100.0, -50.0, 70.0);", (y,))
        cur.execute("INSERT INTO financial_ratios VALUES ('FULL_CO', ?, 20.0, 18.0, 0.05, 20.0, 15.0, 18.0, 'High Quality', 120.0, 'Reinvestor');", (y,))
    ...
    for y in [2023, 2024]:
        cur.execute("INSERT INTO profitandloss VALUES ('SHORT_CO', ?, 100.0, 10.0, 10.0, 1.0, 0.0, 15.0, 0.0);", (y,))
...
def test_sector_report_generation(tmp_path):
    ...
    cur.execute("CREATE TABLE financial_ratios (company_id TEXT, year INT, return_on_equity_pct REAL, roce_pct REAL, debt_to_equity REAL, interest_coverage REAL, operating_profit_margin_pct REAL, free_cash_flow_cr REAL);")
    ...
    cur.execute("INSERT INTO profitandloss VALUES ('SEC_CO1', 2024, 500.0, 100.0, 20.0);")
    cur.execute("INSERT INTO financial_ratios VALUES ('SEC_CO1', 2024, 20.0, 18.0, 0.1, 15.0, 20.0, 80.0);")
