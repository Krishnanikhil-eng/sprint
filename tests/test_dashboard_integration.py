...
class TestDashboardIntegration:
    ...
    def test_dashboard_imports(self):
        ...
        for page in expected_pages:
            ...
            try:
                ...
                ), f"Page {page} missing streamlit import"
    ...
    def test_screener_page_has_filters(self):
        ...
        assert (
            "D/E" in content or "debt_to_equity" in content
        ), "Screener missing D/E filter"
    ...
    def test_screener_page_has_csv_export(self):
        ...
        assert (
            "download_button" in content
        ), "Screener missing download_button for CSV export"
    ...
    def test_screener_page_has_presets(self):
        ...
        assert (
            "PRESET_STRATEGIES" in content or "preset" in content.lower()
        ), "Screener missing preset strategies"
    ...
    def test_valuation_engine_has_fcf_calculation(self):
        ...
        assert (
            "FCF_yield_pct" in content
        ), "Valuation engine missing FCF yield calculation"
        assert (
            "market_cap_crore" in content
        ), "Valuation engine missing market cap reference"
